...
export default function BecomeInstructorPage() {
    ...
    const handleSubmit = async (values: z.infer<typeof requestSchema>) => {
        ...
        try {
            // This single action will create the request and trigger the evaluation in the background.
            await createInstructorRequest({ uid: user.uid, ...values });
            
            toast({ title: 'Candidature envoyée !', description: "Votre dossier est maintenant en cours d'analyse par nos systèmes." });
